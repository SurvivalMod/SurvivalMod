...
import net.mcreator.survivalmod.gui.GUIQuestBook0Gui;
...
public class QuestBookItem extends SurvivalmodModElements.ModElement {
	@ObjectHolder("survivalmod:quest_book")
	public static final Item block = null;
	public QuestBookItem(SurvivalmodModElements instance) {
		super(instance, 27);
	}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Quest Book");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new GUIQuestBook0Gui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
