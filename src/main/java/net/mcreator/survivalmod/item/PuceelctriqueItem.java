...
public class PuceelctriqueItem extends SurvivalmodModElements.ModElement {
	@ObjectHolder("survivalmod:puceelctrique")
	public static final Item block = null;
	public PuceelctriqueItem(SurvivalmodModElements instance) {
		super(instance, 5);
	}
