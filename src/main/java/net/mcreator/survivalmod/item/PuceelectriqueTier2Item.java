...
public class PuceelectriqueTier2Item extends SurvivalmodModElements.ModElement {
	@ObjectHolder("survivalmod:puceelectrique_tier_2")
	public static final Item block = null;
	public PuceelectriqueTier2Item(SurvivalmodModElements instance) {
		super(instance, 7);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("puceelectrique_tier_2");
		}
